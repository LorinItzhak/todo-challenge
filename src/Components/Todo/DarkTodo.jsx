...
export const DarkTodo = ({todo, handleCheckToggle, deleteTodo, index, moveTodo}) => {
    ...
    return <>
        <div className={`singleTodo ${todo.completed ? 'completed' : '' }`} ref={ref} style={{ opacity: isDragging ? 0 : 1 }}>
            <button className="checkCircle" onClick={() => handleCheckToggle(todo.id)}>
